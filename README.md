...
### 🚀 架构创新 (v4.0)
- ✨ **Tauri原生后端** - Rust后端,突破浏览器沙盒
- ✨ **SQLite关系型存储** - 独立表结构,避免JSON记录过大
- ✨ **环境自适应存储** - 自动路由IndexedDB/SQLite
- ✨ **API风控防误杀** - 智能处理400错误、敏感词探测
- ✨ **MCP 标准协议支持** - 提供标准工具接口，允许 Roo Code/Claude 等外部 AI 助手全自动接管小说写作
